...
const TestonomialPage = () => {
  return (
    <section class="py-12 bg-gray-50 sm:py-16 lg:py-20">
        <Helmet>
        <title>Testimonials - Dr. Manas Aggarwal</title>
        <meta name="description" content="Read testimonials from patients who have received care from Dr. Manas Aggarwal, a leading gastroenterology surgeon in Lucknow." />
        <meta name="keywords" content="Patient Testimonials, Dr. Manas Aggarwal, Gastroenterology, Lucknow" />
      </Helmet>
...
export default TestonomialPage